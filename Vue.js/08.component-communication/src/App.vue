<template>
  <section>
    ...
    <new-friend @add-contact="addNewContant"></new-friend>
    <ul>
      <friend-contact
...
export default {
  ...
  methods: {
    toggleFavoriteEvent(friendId) {
      const foundFriend = this.friends.find((fr) => fr.id === friendId);
      foundFriend.isFavorite = !foundFriend.isFavorite;
    },
    addNewContant(name, phone, email) {
